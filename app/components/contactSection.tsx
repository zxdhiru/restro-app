          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-xl text-slate-300 leading-relaxed">
                ...
                get started with RestaurantFlow and take your business to the next level.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-slate-300">123 Tech Street, San Francisco, CA 94105</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-slate-300">24/7 - We're always here to help</div>
                </div>
              </div>
            </div>
